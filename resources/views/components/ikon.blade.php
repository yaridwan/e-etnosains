...
@php
    $isi = match ($nama) {
        ...
        'mata-tercoret' => '<path d="M3.5 3.5 20.5 20.5"/><path d="M10.3 6.02A9.7 9.7 0 0 1 12 5.75c6 0 9.25 6.25 9.25 6.25a13.4 13.4 0 0 1-3.05 3.85M6.6 7.4C4.2 8.9 2.75 12 2.75 12S6 18.25 12 18.25a9.6 9.6 0 0 0 3.53-.67"/><path d="M9.9 10.1a2.5 2.5 0 0 0 3.5 3.5"/>',

<x-layout-dashboard judul-seo="LKPD Saya" :menu="\App\Support\MenuDashboard::guru()">
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-slate-900">LKPD Saya</h1>
                    ...
                    @foreach($lkpd as $item)
                        <tr>
                            ...
                            <td class="py-3 text-right space-x-3">
                                <a href="{{ route('guru.lkpd.edit', $item) }}" class="text-sm font-medium text-teal-700 hover:underline">Ubah</a>

<x-layout-dashboard judul-seo="E-Modul Saya" :menu="\App\Support\MenuDashboard::guru()">
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-slate-900">E-Modul Saya</h1>
                ...
                <tbody class="divide-y divide-slate-100">
                    @foreach($eModul as $item)
                        <tr>
                            ...
                            <td class="py-3 text-slate-500">{{ $item->jumlah_dilihat }}</td>
                            <td class="py-3 text-right space-x-3">
                                <a href="{{ route('guru.e-modul.preview', $item) }}" class="text-sm font-medium text-slate-600 hover:underline">Pratinjau</a>
                                <a href="{{ route('guru.e-modul.edit', $item) }}" class="text-sm font-medium text-teal-700 hover:underline">Ubah</a>

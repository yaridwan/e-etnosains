<x-layout-dashboard judul-seo="Instansi Pendidikan" :menu="\App\Support\MenuDashboard::administrator()">
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-slate-900">Instansi Pendidikan</h1>
        ...
        <table class="w-full text-left text-sm">
            ...
            <tbody class="divide-y divide-slate-100">
                @forelse($data as $item)
                    <tr>
                        <td class="py-3 font-medium text-slate-700">{{ $item->nama_instansi }}</td>
                        <td class="py-3 text-slate-500">{{ $item->jenis_instansi }}</td>
                        <td class="py-3 text-slate-500">{{ $item->kota }}</td>
                        <td class="py-3 text-right">
                            ...
                            <x-form-hapus :aksi="route('admin.instansi-pendidikan.destroy', $item)" class="inline" />
                        </td>
                    </tr>
